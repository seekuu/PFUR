//Volshikov NI-202
/* 27. Дан массив размера N. Найти номер и значение его первого локального минимума (локальный минимум – это элемент, который меньше любого из своих соседей).*/
#include <iostream>
//#include <conio.h>
#define LEN 100
using namespace std;
...
{
int k=0;
cout<<"Perviy local'niy  minimum "<<endl;
for(int i =1 ;i<kol-1;i++){if(mas[i+1]>mas[i] and mas[i]<mas[i-1]){cout<<"Index : "<<i<<" "<<"Element : "<<mas[i];k=1;break;}}
if(k==0)cout<<"Net minimumov";
}
