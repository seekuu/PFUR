//Volshikov NI-202
/*2. В массиве из n чисел найти первый отрицательный элемент и его индекс в массиве. */
#include <iostream>
//#include <conio.h>
#define LEN 100
using namespace std;
...
int A::cnt()
{
cout<<"Perviy neotricatel'niy element "<<endl;
for(int i =0 ;i<kol;i++)if(mas[i]>=0)return(mas[i]);
}
